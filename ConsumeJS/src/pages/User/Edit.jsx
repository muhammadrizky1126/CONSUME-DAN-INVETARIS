    ...
    const handleEditUser = (event) => {
        ...
        instance.put(`users/update/${id}`, forms)
            .then(() => {
                ...
                setTimeout(() => {
                    navigate('/user');
                }, 2000); // Navigate back to user list after 2 seconds
            })
            .catch(err => {
        ...
        <div className="block m-auto h-screen bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            <div className="items-center m-5 pb-10 pt-10">
                ...
                {error && error.length > 0 && (
                    <div role="alert">
                        ...
                        <div className="border border-t-0 border-red-400 rounded-b bg-red-100 px-4 py-3 text-red-700">
                            <ul>
                                {typeof error === 'string' ? <li>{error}</li> : error.map((errMsg, index) => (
                ...
                <div className="text-center mb-6">
                    <h5 className="text-3xl font-medium text-gray-900 dark:text-white">Edit User</h5>
                </div>
